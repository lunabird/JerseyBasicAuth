...
public class ApplicationUninstallBase {
	...
	public int sendUninstallMemcachedLinuxMsg( String ip,String softName,String path) {
		// TODO Auto-generated method stub
...
//	}
	...
	public int sendUninstallMemcachedMsg( String ip,String softName) {
		// TODO Auto-generated method stub
		int opID = insertEvent(ip,"uninstall-Memcached");
		//发送Socket消息给Agent
		try {
	...
	public int sendUninstallOracle11gLinuxMsg( String ip,String oraclepath,String user) {
		// TODO Auto-generated method stub
		int opID = insertEvent(ip,"uninstall-Oracle11g");
		//发送Socket消息给Agent
		try {
